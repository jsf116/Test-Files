...
In the generic form (i.e. if the 3rd parameter B<\%options> is passed and contains the key B<FILTER>)
...
In the generic form i.e. if the 3rd parameter B<\%options> is passed and
